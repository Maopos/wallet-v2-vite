...
const ListadoGastos = ({ gastos, modal, setGastoEditar, eliminarGasto }) => {
  return (
    <div className={modal ? "hidden" : ""}>
      <div className="bg-white mt-5 mx-5 md:w-1/2 md:mx-auto shadow-sm shadow-green-700 py-5 md:py-16 px-5 md:px-20 text-center">
        <h2 className="text-green-700 font-semibold text-2xl border-b-2 m-5">
          {gastos.length ? "Listado Gastos" : "No hay gastos aún"}
        </h2>
        <h2 className="text-green-700 text-2xl justify-between m-5">
          {gastos.length ? (
